...
// --------------------------------------------------------------------------------------------------
 namespace Ar.Com.Hjg.Pngcs {
	...
	public class PngHelper {
		...
		public static Encoding charset = System.Text.Encoding.GetEncoding("ISO-8859-1"); // charset
        ...
        public static HashSet<String> AsSet(params String[] values)
        {
			return new HashSet<String>(values);
		}

        public static HashSet<String> UnionSets(HashSet<String> set1, HashSet<String> set2)
        {
        ...
        public static HashSet<String> UnionSets(HashSet<String> set1, HashSet<String> set2,HashSet<String> set3 )
        {
            HashSet<String> s = new HashSet<String>();
            s.UnionWith(set1);
            s.UnionWith(set2);
		...
		public static double ResMetersToDpi(long res) {
			return (double) res * 0.0254d;
		}
	
		public static long ResDpiToMeters(double dpi) {
			return (long) (dpi / 0.0254d + 0.5d);
		}
