    ...
    public class ImageLineHelper
    {
        ...
        public class ImageLineStats
        {
            ...
            public ImageLineStats(ImageLine line)
            {
                ...
                this.maxv = new double[] { Ar.Com.Hjg.Pngcs.ImageLineHelper.BIG_VALUE_NEG, Ar.Com.Hjg.Pngcs.ImageLineHelper.BIG_VALUE_NEG, Ar.Com.Hjg.Pngcs.ImageLineHelper.BIG_VALUE_NEG, Ar.Com.Hjg.Pngcs.ImageLineHelper.BIG_VALUE_NEG };
                this.minv = new double[] { Ar.Com.Hjg.Pngcs.ImageLineHelper.BIG_VALUE, Ar.Com.Hjg.Pngcs.ImageLineHelper.BIG_VALUE, Ar.Com.Hjg.Pngcs.ImageLineHelper.BIG_VALUE, Ar.Com.Hjg.Pngcs.ImageLineHelper.BIG_VALUE };
                this.promlum = 0.0d;
                this.maxlum = Ar.Com.Hjg.Pngcs.ImageLineHelper.BIG_VALUE_NEG;
                this.minlum = Ar.Com.Hjg.Pngcs.ImageLineHelper.BIG_VALUE;
                this.maxdif = new double[] { Ar.Com.Hjg.Pngcs.ImageLineHelper.BIG_VALUE_NEG, Ar.Com.Hjg.Pngcs.ImageLineHelper.BIG_VALUE_NEG, Ar.Com.Hjg.Pngcs.ImageLineHelper.BIG_VALUE_NEG, Ar.Com.Hjg.Pngcs.ImageLineHelper.BIG_VALUE };
                ...
                for (int i = 0; i < line.ImgInfo.Cols; i++)
                {
                    ...
                    {
                        x = Ar.Com.Hjg.Pngcs.ImageLineHelper.Int2double(line, line.Scanline[i * channels]);
                        if (ch < 3)
                            lum += x;
                        prom[ch] += x;
                        if (x > maxv[ch])
                        ...
                        if (i >= channels)
                        {
                            d = Math.Abs(x - Ar.Com.Hjg.Pngcs.ImageLineHelper.Int2double(line, line.Scanline[i - channels]));
                            if (d > maxdif[ch])
                                maxdif[ch] = d;
                        }
                    }
